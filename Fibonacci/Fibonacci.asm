...
program_start_message DB "This version of the program calculates the fibinacci sequence without a function call, using a loop made with jump instructions (Assembly Assignment 1)", 0ah, "Type any number to get the fibonacci value > ", 00h
