...
program_start_message DB "This version of the program calculates the fibinacci sequence without a function call, using a loop made with loop instructions (Assembly Assignment 2)", 0ah, "Type any number to get the fibonacci value > ", 00h
fibonacci_start_msg_1 DB "To calculate ", 00h
fibonacci_start_msg_2 DB " start with 1, 1 and add the last two numbers in sequence over and over", 0ah, 00h
...
_main:
	...
	; TODO: redo entire fibonacci sequence
	mov		[previous],	1
	mov		[current],	1
	mov		[next],		1

	cmp		ebx,	1
	jle		_fibonacci_jmp_end
...
_fibonacci_jmp:
	...
	push	offset fibonacci_process_1
	call	PrintLine
	...
	push	offset fibonacci_process_2
	call	PrintLine
